...
//*
//*
//*Concept , Backend code , Debugging by Ahmed Muhammad Shafique
//*Shapes calculations by Asha Mony
//*
//*
//*
...
void onMouseLeftClick(int mx,int my){
    ...
    //Else draw selected/default function
        ...
        if(drawMode==1) drawAScaledTuftOfGrass(0.7,0.7,mx,my-15);
        else if(drawMode==2) drawAScaledSimpleTree(0.5,0.5,mx,my);
...
{
	if(my < paletteYBound){
        if(drawMode==1) drawAScaledTuftOfGrass(0.7,0.7,mx,Y-my-15);
        ...
        else if(drawMode==10) drawWater(3,3,mx,Y-my);
